...
export const getCommentOnPost = createAsyncThunk("/comment/fetch", async(data ,thunkAPI)=>{
...
export const postComment = createAsyncThunk("/comment/post", async (data , thunkAPI)=>{
    const{postId, token , commentText}= data
try {
