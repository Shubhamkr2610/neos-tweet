...
import { NewPost, Posts, Sidebar, SidebarBottom, UserSuggestion } from "../../components";
    ...
    <>
      ...
      <div className="flex relative">
        ...
        <div className="w-full md:w-[90%] flex flex flex-col m-2 sm:m-4">
          ...
          {posts?.filter((post)=>post.username===user.username).map(({_id, content,username,firstName,lastName,comments, userphoto})=>(<Posts key={_id}
          _id={_id} content={content} username={username} firstName={firstName} lastName={lastName} userphoto={userphoto} />))}
